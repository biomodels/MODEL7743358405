...
`pip install git+https://github.com/biomodels/MODEL7743358405.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL7743358405.git@20140916`

## Usage

Importing the model package.

`import MODEL7743358405 as model`
